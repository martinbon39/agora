...
const SECTION_BOUNDS = [
  ...
  ['logo', M.drop, M.actCanvas],
  ['canvas', M.actCanvas, M.actMultiplayer],
  ['multiplayer', M.actMultiplayer, M.actAgentTalk],
  ['agentTalk', M.actAgentTalk, M.actHarnesses],
  ['harnesses', M.actHarnesses, M.actLaptop],
  ['laptop', M.actLaptop, M.climax],
